...
public class LiStringUtils implements StrPool {
    ...
    public static boolean equalsAny(final CharSequence string, final CharSequence... searchStrings) {
        if (LiArrayUtils.isNotEmpty(searchStrings)) {
    ...
    public static boolean equalsIgnoreCase(final CharSequence cs1, final CharSequence cs2) {
        ...
        return LiCharSequenceUtils.regionMatches(cs1, true, 0, cs2, 0, cs1.length());
    }
     ...
     * @since 3.6 Updated {@link LiCharSequenceUtils} call to behave more like <code>String</code>
     */
    public static int indexOf(final CharSequence seq, final int searchChar) {
        if (isEmpty(seq)) {
            return INDEX_NOT_FOUND;
        }
        return LiCharSequenceUtils.indexOf(seq, searchChar, 0);
    }
    ...
    public static int indexOf(final CharSequence seq, final int searchChar, final int startPos) {
        ...
        return LiCharSequenceUtils.indexOf(seq, searchChar, startPos);
    }
    ...
    public static int indexOf(final CharSequence seq, final CharSequence searchSeq) {
        ...
        return LiCharSequenceUtils.indexOf(seq, searchSeq, 0);
    }
    ...
    public static int indexOf(final CharSequence seq, final CharSequence searchSeq, final int startPos) {
        ...
        return LiCharSequenceUtils.indexOf(seq, searchSeq, startPos);
    }
    ...
    private static int ordinalIndexOf(final CharSequence str, final CharSequence searchStr, final int ordinal, final boolean lastIndex) {
        ...
        do {
            if (lastIndex) {
                index = LiCharSequenceUtils.lastIndexOf(str, searchStr, index - 1); // step backwards thru string
            } else {
                index = LiCharSequenceUtils.indexOf(str, searchStr, index + 1); // step forwards through string
            }
            if (index < 0) {
                return index;
            }
    ...
    public static int indexOfIgnoreCase(final CharSequence str, final CharSequence searchStr, int startPos) {
        ...
        for (int i = startPos; i < endLimit; i++) {
            if (LiCharSequenceUtils.regionMatches(str, true, i, searchStr, 0, searchStr.length())) {
                return i;
            }
        }
        return INDEX_NOT_FOUND;
    ...
    public static int lastIndexOf(final CharSequence seq, final int searchChar) {
        ...
        return LiCharSequenceUtils.lastIndexOf(seq, searchChar, seq.length());
    }
    ...
    public static int lastIndexOf(final CharSequence seq, final int searchChar, final int startPos) {
        ...
        return LiCharSequenceUtils.lastIndexOf(seq, searchChar, startPos);
    }
    ...
    public static int lastIndexOf(final CharSequence seq, final CharSequence searchSeq) {
        ...
        return LiCharSequenceUtils.lastIndexOf(seq, searchSeq, seq.length());
    }
    ...
    public static int lastIndexOf(final CharSequence seq, final CharSequence searchSeq, final int startPos) {
        ...
        return LiCharSequenceUtils.lastIndexOf(seq, searchSeq, startPos);
    }
    ...
    public static boolean contains(final CharSequence seq, final int searchChar) {
        ...
        return LiCharSequenceUtils.indexOf(seq, searchChar, 0) >= 0;
    }
    ...
    public static boolean containsIgnoreCase(final CharSequence str, final CharSequence searchStr) {
        ...
        for (int i = 0; i <= max; i++) {
            if (LiCharSequenceUtils.regionMatches(str, true, i, searchStr, 0, len)) {
                return true;
            }
        }
        return false;
    ...
    public static int indexOfAny(final CharSequence cs, final char... searchChars) {
        if (isEmpty(cs) || LiArrayUtils.isEmpty(searchChars)) {
            return INDEX_NOT_FOUND;
        }
    ...
    public static boolean containsAny(final CharSequence cs, final CharSequence searchChars) {
        ...
        return containsAny(cs, LiCharSequenceUtils.toCharArray(searchChars));
    }
    ...
    public static boolean containsAny(final CharSequence cs, final CharSequence... searchCharSequences) {
        if (isEmpty(cs) || LiArrayUtils.isEmpty(searchCharSequences)) {
            return false;
        }
    ...
    public static boolean contains(final CharSequence seq, final CharSequence searchSeq) {
        ...
        return LiCharSequenceUtils.indexOf(seq, searchSeq, 0) >= 0;
    }
    ...
    public static int indexOfAnyBut(final CharSequence seq, final CharSequence searchChars) {
        ...
        for (int i = 0; i < strLen; i++) {
            ...
            final boolean chFound = LiCharSequenceUtils.indexOf(searchChars, ch, 0) >= 0;
            if (i + 1 < strLen && Character.isHighSurrogate(ch)) {
                final char ch2 = seq.charAt(i + 1);
                if (chFound && LiCharSequenceUtils.indexOf(searchChars, ch2, 0) < 0) {
                    return i;
                }
            } else {
                if (!chFound) {
    ...
    public static int indexOfAny(final CharSequence str, final CharSequence... searchStrs) {
        ...
        for (final CharSequence search : searchStrs) {
            ...
            tmp = LiCharSequenceUtils.indexOf(str, search, 0);
    ...
    public static int lastIndexOfAny(final CharSequence str, final CharSequence... searchStrs) {
        ...
        for (final CharSequence search : searchStrs) {
            ...
            tmp = LiCharSequenceUtils.lastIndexOf(str, search, str.length());
            if (tmp > ret) {
                ret = tmp;
            }
        }
    ...
    public static String[] substringsBetween(final String str, final String open, final String close) {
        ...
        if (strLen == 0) {
            return LiArrayUtils.EMPTY_STRING_ARRAY;
        }
    ...
    private static boolean startsWith(final CharSequence str, final CharSequence prefix, final boolean ignoreCase) {
        ...
        return LiCharSequenceUtils.regionMatches(str, ignoreCase, 0, prefix, 0, prefix.length());
    }
    ...
    public static String removeAll(final String text, final String regex) {
        return LiRegExUtils.removeAll(text, regex);
    }
    ...
    public static String replaceFirst(final String text, final String regex, final String replacement) {
        return LiRegExUtils.replaceFirst(text, regex, replacement);
    }
    ...
    public static String replacePattern(final String source, final String regex, final String replacement) {
        return LiRegExUtils.replacePattern(source, regex, replacement);
    }
    ...
    public static String removePattern(final String source, final String regex) {
        return LiRegExUtils.removePattern(source, regex);
    }
    ...
    public static String replaceAll(final String text, final String regex, final String replacement) {
        return LiRegExUtils.replaceAll(text, regex, replacement);
    }
     ...
     * @deprecated This feature will be removed in Lang 4.0, use {@link LiStringUtils#removeEnd(String, String)} instead
     */
    @Deprecated
    ...
    public static int countMatches(final CharSequence str, final CharSequence sub) {
        ...
        int count = 0;
        int idx = 0;
        while ((idx = LiCharSequenceUtils.indexOf(str, sub, idx)) != INDEX_NOT_FOUND) {
            count++;
            idx += sub.length();
        }
        return count;
    ...
    public static boolean isAsciiPrintable(final CharSequence cs) {
        ...
        final int sz = cs.length();
        for (int i = 0; i < sz; i++) {
            if (!LiCharUtils.isAsciiPrintable(cs.charAt(i))) {
                return false;
            }
        }
        return true;
     ...
     * @see LiStringUtils#defaultString(String, String)
     */
     ...
     * @see LiStringUtils#startsWith(CharSequence, CharSequence)
     * @since 2.5
     * @since 3.0 Changed signature from startsWithAny(String, String[]) to startsWithAny(CharSequence, CharSequence...)
     */
    public static boolean startsWithAny(final CharSequence sequence, final CharSequence... searchStrings) {
        if (isEmpty(sequence) || LiArrayUtils.isEmpty(searchStrings)) {
            return false;
        }
     ...
     * @see LiStringUtils#endsWith(CharSequence, CharSequence)
     * @since 3.0
     */
     ...
     * @since 3.1
     * @deprecated use {@link LiStringUtils#toEncodedString(byte[], Charset)} instead of String constants in your code
     */
    @Deprecated
    ...
    public static int[] toCodePoints(final CharSequence str) {
        ...
        if (str.length() == 0) {
            return LiArrayUtils.EMPTY_INT_ARRAY;
        }
