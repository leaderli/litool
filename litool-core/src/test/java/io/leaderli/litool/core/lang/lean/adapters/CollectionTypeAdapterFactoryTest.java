...
class CollectionTypeAdapterFactoryTest {
    ...
    void test() {
        ...
        LiTypeToken<List<String>> liTypeToken = LiTypeToken.getParameterized(List.class, String.class);
        ...
        TypeAdapter<Set<String>> typeAdapterSet = new CollectionTypeAdapterFactory().create(lean, LiTypeToken.getParameterized(Set.class, Integer.class));
        ...
        Assertions.assertEquals(CollectionUtils.toSet(), lean.fromBean(null, LiTypeToken.getParameterized(Set.class)));
        Assertions.assertEquals(CollectionUtils.toSet(1, 2), lean.fromBean(CollectionUtils.toList(1, 2, 1), LiTypeToken.getParameterized(Set.class, Integer.class)));
    }
}
