...
public class LiCharsetUtil {
    ...
    public static Charset charset(String charsetName) throws UnsupportedCharsetException {
        return LiStringUtils.isBlank(charsetName) ? Charset.defaultCharset() : Charset.forName(charsetName);
    }
    ...
    public static Charset parse(String charsetName, Charset defaultCharset) {
        if (LiStringUtils.isBlank(charsetName)) {
    ...
    public static String convert(String source, Charset srcCharset, Charset destCharset) {
        ...
        if (LiStringUtils.isBlank(source) || srcCharset.equals(destCharset)) {
            return source;
        }
    ...
    /**
     * 系统字符集编码，如果是Windows，则默认为GBK编码，否则取 {@link LiCharsetUtil#defaultCharsetName()}
     *
     * @return 系统字符集编码
     * @see LiCharsetUtil#defaultCharsetName()
     * @since 3.1.2
     */
    ...
    public static Charset systemCharset() {
        return LiFileUtil.isWindows() ? CHARSET_GBK : defaultCharset();
    }
}
