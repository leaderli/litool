...
class LiIfTest {
    ...
    void test_if() {
        ...
        Assertions.assertEquals(Lino.of(789),
                LiIf.<Integer, Integer>of(null)._if(i -> i == 123).then(i -> 456)._else(() -> 789));
        Assertions.assertEquals(Lino.of(456),
                LiIf.<Integer, Integer>of(123)._if(i -> i == 123).then(i -> 456)._else(() -> 789));
        Assertions.assertEquals(Lino.of(789),
    ...
    void test_instanceof() {
        ...
        Assertions.assertEquals(Lino.of(789),
                LiIf.<Integer, Integer>of(null)._instanceof(Integer.class).then(i -> 456)._else(() -> 789));
        Assertions.assertEquals(Lino.of(456),
    ...
    void test_case() {
        ...
        Assertions.assertEquals(Lino.of(456),
                LiIf.<Integer, Integer>of(123)._case(123, 456).then(i -> 456)._else(() -> 789));
        Assertions.assertEquals(Lino.of(789),
                LiIf.<Integer, Integer>of(1)._case(123, 456).then(i -> 456)._else(() -> 789));

        Assertions.assertEquals(Lino.of(789),
                LiIf.<Integer, Integer>of(1)._case((Integer) null).then(i -> 456)._else(() -> 789));
        Assertions.assertEquals(Lino.of(789),
                LiIf.<Integer, Integer>of(1)._case((Integer[]) null).then(i -> 456)._else(() -> 789));
