...
import static io.leaderli.litool.core.text.CharPool.CR;
...
public class Tailer implements Runnable {
    ...
    public Tailer(final File file, final TailerListener listener) {
        this(file, listener, DEFAULT_DELAY_MILLIS, true);
    }
    ...
    public void run() {
        ...
        try {
            ...
            while (getRun()) {
                final boolean newer = FileUtil.isFileNewer(file, last); // IO-279, must be done first
